...
L'application host n'est pas seulement un binaire d'appoint. C'est le runtime côté machine qui s'enregistre, s'identifié, envoie des heartbeats et accepte ou refusé les sessions.
