...
Diese Seite erfasst alle `docker-compose.yml`- und `Dockerfile`-Dateien, die in den aktuell gemounteten Docker-Quellbaeumen gefunden wurden.
...
Hinweis: Identischer Inhalt fuer die untenstehenden Pfade.
