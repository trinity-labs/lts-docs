...
Cette page est le point d'entrée pratique de `TRINITY`. Elle explique comment utiliser la plateforme depuis la première visite jusqu'à une situation plus technique autour d'une VM ou d'une reprise.
