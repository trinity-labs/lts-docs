...
Cette clarification est importante : le support commercial et le support technique ne sont pas limitées au coeur historique de la plateforme. Ils couvrent aussi les surfaces de contrôle et d'accès distant utilisées autour d'elle.
